...
Route::middleware(['auth','isParent'])->group(function(){
	...
	Route::get('/parent/pembayaran', [
		App\Http\Controllers\Parent\PaymentController::class, 'index'
	]);
	Route::get('/parent/tagihan', [
		App\Http\Controllers\Parent\InvoiceController::class, 'index'
	]);
});